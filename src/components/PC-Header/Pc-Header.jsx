          ...
          <a target="_blank" href="https://t.me/+YJdPUtUHRNo5NTM6">
            ...
            <div className='pc-head'>
                <div className='contents'>
                    ...
                    <p className='pc-p'>Razer systems are crafted to provide the ultimate performance for gaming and
                        work. Enjoy desktop
                        power made <br/> mobile with our gaming and productivity laptops, or go all-out for your build
                        as you
                        assemble the most powerful <br/> aRGB Chroma powered battlestation.</p>
                </div>
            </div>
            <div className='pc-bg'>
                <div className='container'>
                    <div className='parent1'>
                        <div className='card-1 pc-card1'>
                            <HashLink to='/store#headsets'>
                                ...
                                <div className='inside-c'>
                                    <h3>HEADSETS</h3>
                                    <p>Tuned for gaming, lifestyle, or a perfect mix of both and also...</p>
                        ...
                        <div className='card0 pc-card1'>
                            <HashLink to='/store#mice'>
                                ...
                                <div className='inside-c'>
                                    <h3>MICE</h3>
                                    <p>Pixel-perfect precision for any hand size and grip style and...</p>
                                    <button>Learn More {'>'}</button>
                                </div>
                            </HashLink>
                        </div>
                        <div className='card1 pc-card1'>
                            <HashLink to='/store#laptop'>
                                ...
                                <div className='inside-c'>
                                    <h3>LAPTOPS</h3>
                                    <p>Sleek high-performance gaming laptops. So you can buy ...</p>
                                    <button>Learn More {'>'}</button>
                                </div>
                            </HashLink>
                        </div>
                        ...
                        <div className='card3 pc-card1'>
                            <HashLink to='/store#gear'>
                                ...
                                <div className='inside-c'>
                                    <h3>ACCESSORIES</h3>
                                    <p>Crafting the perfect gaming experience. So you can buy and show ...</p>
                                    <button>Learn More {'>'}</button>
                                </div>
                            </HashLink>
                        </div>
                        <div className='card3 pc-card1'>
                            <HashLink to='/store#chairs'>
                                ...
                                <div className='inside-c'>
                                    <h3>CHAIRS</h3>
                                    <p>Perfecting the science of comfort and support and others from ...</p>
                                    <button>Learn More {'>'}</button>
                                </div>
                            </HashLink>
                        </div>
