        ...
        <div className="container">
          <div className="mobile-grid">
            ...
            <div className="m-card1">
              ...
              <h2>RAZER KISHI</h2>
              <p>Make your move with our award-winning universal mobile controller that fits most smartphone devices, designed to bring console-level control and comfort to your on-the-go gaming.</p>
              <HashLink to="/store#mobile">Learn More {">"}</HashLink>
            </div>
          </div>
        </div>
