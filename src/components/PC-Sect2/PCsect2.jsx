    ...
    return (
        <>
            ...
            <div className='dark-content1'>
                ...
                <p className='pc-p'>Whether you’re finding your footing, raking in the views, or somewhere in between, we’ve got gear
                    catered to the full <br/> spectrum of streamers, so you’ll always have the quality and clarity you need to
                    keep your audience engaged <br/> and entertained.</p>
            </div>
            <div className='pc-bg'>
                    ...
                    <div className='parent1'>
                        ...
                        <div className='card2 pc-card1'>
                            <HashLink to='/store#streaming'>
                                ...
                                <div className='inside-c'>
                                    <h3>MICROPHONES</h3>
                                    <p>Engineered for crystal-clear voice pickup and help you ...</p>
                                    <button>Learn More {'>'}</button>
                                </div>
                            </HashLink>
                        </div>
