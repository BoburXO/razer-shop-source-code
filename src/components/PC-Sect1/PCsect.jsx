        ...
        <>
            <div className='PC-Sect'>
                    <div className='dark-content'>
                        <div className='texts'>
                            <h1 className='pc-h1 pcs-h1'>
                                PERIPHERALS
                            </h1>
                            <p className='pc-p pcs-p'>
                                The most powerful rigs mean nothing without the high-performance gear to match.
                                Understand what it means to <br/> wield the unfair advantage as you experience
                                industry-leading levels of precision, control, and immersion.
                            </p>
                        </div>
                    </div>
                <div className='container'>
                    <div className='two-div'>
                        ...
                        <h2>MICE</h2>
                            <HashLink to='/store#mice'><button>Learn More {">"}</button></HashLink>
                        </div>
