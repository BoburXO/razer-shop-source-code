        ...
        <div id="row">
            ...
            <div className="left1">
                <div className="left-btn-div">
                    <Link to="/store">
                        <button><span className='st3'>RAZER.COM</span> <br/><span className='st4'>EXCLUSIVE</span>
                        </button>
                    </Link>
                </div>
                ...
                <div className="left-gridbox">
                    <Link to="/store">
                        <button className="link-btn1">Learn More <span>{">"}</span></button>
                    </Link>
                    <Link to="/store">
                        <button>Buy <span>{">"}</span></button>
                    </Link>
            ...
            <div className="left2">
                <div className='left2-h'>
                    ...
                    <Link to='/store'>
                        <button className='left2-btn'>Shop Exclusive Deals <span className='arrow'>{">"}</span></button>
                    </Link>
                </div>
            </div>
